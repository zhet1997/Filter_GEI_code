...
%
% ======================================================================
%> @brief Wrapper包装 around the matlab optimizers.
% ======================================================================
classdef MatlabGA < Optimizer
	
	% private members
	properties (SetAccess = 'private', GetAccess = 'public')%'private')
		problem;
	end
	...
	methods
        ...
        % ======================================================================
		function this = MatlabGA(varargin)%输入是（1，1）
			% call superclass
			...
			this.problem = problem;%储存到this.problem中
		end % constructor
