...
% ======================================================================
classdef Kriging < BasicGaussianProcess
%Kriging是继承于BasicGaussianProcess的子类，Kriging中没有fit函数的覆盖，直接继承了fit函数
	properties (Access = private)%这里改了一下，原来是private		
        % preprocessing values
        %inputScaling和outputScaling是Kriging所特有的，但还没有找到是从哪里计算的。
