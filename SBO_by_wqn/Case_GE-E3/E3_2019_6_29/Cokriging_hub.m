...
%用于hub截面的优化
clc;clear;
load('D:\Users\ASUS\Desktop\迁移学习算例20190601\opt_tip_271.mat');%载入已经构建完成的tip响应面

path = 'D:\Users\ASUS\Desktop\迁移学习算例\hub\';
...
points0_l = importdata([path,file1]);%载入坐标
values0_l = importdata([path,file2]);%载入样本值

file1 = 'iter_new_points_l.dat';
file2 = 'iter_new_points_h.dat';
file3 = 'iter_new_values.dat';
points_l = importdata([path,file1]);%载入坐标
